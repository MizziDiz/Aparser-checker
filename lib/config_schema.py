...
CONFIG_FIELDS: list[dict] = [
    ...
    {"group": "Релей", "key": "telegram_relay_url", "type": "str", "default": "",
     "label": "URL релея (на клиентах)", "help": "напр. http://192.0.2.10:8899; пусто — не через релей"},
    ...
    {"group": "Релей", "key": "relay_bind", "type": "str", "default": "0.0.0.0",
     "label": "Адрес прослушивания релея", "help": "лучше IP локальной сети, напр. 192.0.2.10"},
    {"group": "Релей", "key": "relay_allowed_ips", "type": "str", "default": "",
     "label": "Разрешённые IP (на релее)", "help": "напр. 192.0.2.0/24; пусто — все (не рекомендуется)"},
