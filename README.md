...
- Раз в `heartbeat_every` успешных прогонов (по умолчанию 12 → ~раз в час при интервале 5 мин) в Telegram уходит **🟢 «всё ок»** со сводкой — подтверждение, что мониторинг жив. `0` в конфиге отключает heartbeat.
